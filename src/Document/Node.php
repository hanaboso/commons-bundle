...
namespace Hanaboso\CommonsBundle\Document;
 ...
 * Class Node
 *
 * @MongoDB\Document(repositoryClass="Hanaboso\CommonsBundle\Repository\NodeRepository")
 *
 * @package Hanaboso\CommonsBundle\Document
 */
class Node
{
     ...
     *
     * @MongoDB\EmbedMany(targetDocument="Hanaboso\CommonsBundle\Document\Embed\EmbedNode")
     */
    protected $next = [];
